@global_pi= global i32 2
@global_pi= global i32 _2
...
%new_var0 = load i8**, i8*** %pont_b
call void @main(i32 2,i8** %new_var0)
%new_var1 = load i32, i32* @global_pi
%new_var2 = load i8**, i8*** %pont_b
call void @main(i32 %new_var1,i8** %new_var2)
ret void
}
